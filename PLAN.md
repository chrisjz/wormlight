...
- `gpu`: parity on SwiftShader, from milestone 2.
...
| 2                     | The neural model on the GPU, with the parity CI job                                                                                                                                                                      | Parity passes on CI's software GPU and on the Mac; a Safari check; the full-step speed measured against the 10× target |
