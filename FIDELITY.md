...
| Chemical synapses (3,709 connections)  | 5     | Serial-section EM, Cook et al. 2019, released under CC BY in Emmons 2024                                    | Assembled from several animals, with some connections extrapolated where no EM data existed; counts are EM sections, which fold synapse number and size together; includes 38 autapses   | More whole-animal connectomes             |
| Gap junctions (1,095 pairs)            | 5     | Cook et al. 2019, with the lab's July 2020 corrections and 2023 BDU–ALM and BDU–PLM junctions (Emmons 2024) | As above; no rectification or innexin identity                                                                                                                                           | Innexin expression and rectification data |
| Neuromuscular connections (95 muscles) | 5     | Cook et al. 2019, as released in Emmons 2024                                                                | As above                                                                                                                                                                                 |                                           |
...
| Muscle placement along the body                           | 0     | Assumed to sit on one grid of 24 slots in every quadrant, the 23-cell ventral-left quadrant's last cell covering two, as Cook's innervation suggests |                                                               | Measured muscle positions          |
