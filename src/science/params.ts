...
export const PARAMS = {
  ...
  muscleEfficacy: {
    ...
    subsystem: 'muscle',
    sources: ['boyle2012'],
    note: 'F_max,m = 0.70 − 0.42 (m − 1)/M, falling towards the tail, and 0.7 × 2/3 for the first muscle so the tip of the head does not over-bend (Table 1).',
