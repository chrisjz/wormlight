...
// Only requestAdapter is exercised, so a partial GPU is enough for these fakes.
...
describe('probeWebGpu', () => {
  ...
  it('names the adapter it was given', async () => {
    const adapter = { info: { vendor: 'apple', architecture: 'metal-3' } };
